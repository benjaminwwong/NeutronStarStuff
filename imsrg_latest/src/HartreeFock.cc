...
{
  arma::mat F_hfbasis = C.t() * F * C;
  arma::mat Vij_hfbasis = C.t() * Vij * C;
  arma::mat V3ij_hfbasis = C.t() * V3ij * C;
  std::cout << std::fixed << std::setw(3) << "i" << ": " << std::setw(3) << "n" << " " << std::setw(3) << "l" << " "
       << std::setw(3) << "2j" << " " << std::setw(3) << "2tz" << std::setw(12) << "occ." << "   " << std::setw(12) 
       << "F" << " " << std::setw(12) << "Vij" << std::setw(12) << "V3ij" << std::endl;
//  for (size_t i=0;i<modelspace->GetNumberOrbits();++i)
  for ( auto i : modelspace->all_orbits )
  {
    Orbit& oi = modelspace->GetOrbit(i);
    std::cout << std::fixed << std::setw(3) << i << ": " << std::setw(3) << oi.n << " " << std::setw(3) << oi.l << " "
         << std::setw(3) << oi.j2 << " " << std::setw(3) << oi.tz2 << std::setw(12) << oi.occ << "   " 
         << std::setw(12) << std::setprecision(6) << F_hfbasis(i,i) << " " << std::setw(12) << std::setprecision(6)
         << Vij_hfbasis(i,i) << " " << std::setw(12) << std::setprecision(6) << V3ij_hfbasis(i,i) << std::endl;
...
//   bool this_is_the_one = ( twoJ==3 and Tbc_bra.parity == 1 and Tbc_bra.twoTz==-1 and Tbc_ket.twoTz==3);
//   std::cout << " ^^^^^^^^ " << twoJ << "  " << Tbc_bra.parity << "  " << Tbc_bra.twoTz << "  " << Tbc_ket.twoTz << std::endl;
