 ...
 for reference in ['%s%d'%(ELEM[Z],A)]:
  ...
  for e in [6,8,10,12]:
   for hw in [16]:
     ...
     ARGS['2bme'] = '/home/b62wong/projects/def-holt/shared/me2j/TwBME-HO_NN-only_N3LO_EM500_srg1.80_hw%d_emax18_e2max36.me2j.gz'%(hw)
     ARGS['3bme'] = '/home/b62wong/projects/def-holt/shared/me3j/NO2B_ThBME_EM1.8_2.0_3NFJmax15_IS_hw%d_ms18_36_24.stream.bin'%(hw)
     ARGS['LECs'] = 'EM1.8_2.0'
...
#     ARGS['method'] = method
     ...
     ARGS['Operators'] = 'ISM,ISQ,IVM,IVQ'    # Operators to consistenly transform, separated by commas.
#     ARGS['Operators'] = 'Rp2'
